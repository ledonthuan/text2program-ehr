...
if __name__ == '__main__':
    db_conn = sqlite3.connect(os.path.join(PJT_ROOT_PATH, './mimicsql/evaluation/mimic_db/sample_mimic.db'))
    ...
    print('SAVE KG ...')
    kg.serialize('mimic_sparql/build_mimicsparql_kg/mimic_sparql_kg.xml', format='xml')
    print('SAVE DONE')
    print('LOAD TEST ...')
    kg = Graph()
    kg.parse('mimic_sparql/build_mimicsparql_kg/mimic_sparql_kg.xml', format='xml', publicID='/')
